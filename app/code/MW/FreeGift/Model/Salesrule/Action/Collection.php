 ...
 */
namespace MW\FreeGift\Model\Salesrule\Action;
...
class Collection extends \Magento\Rule\Model\Action\Collection
{
    ...
    public function __construct(
        ...
        $this->setType('MW\FreeGift\Model\Salesrule\Action\Collection');
    }
    ...
    public function getNewChildSelectOptions()
    {
        ...
        $actions = array_merge_recursive(
            $actions,
            [
                ['value' => 'MW\FreeGift\Model\Salesrule\Action\Product', 'label' => __('Update the Product')]
            ]
        );
        return $actions;
    }
