 ...
 */
class Rule extends \Magento\Rule\Model\AbstractModel implements \MW\FreeGift\Api\Data\RuleInterface, \Magento\Framework\DataObject\IdentityInterface
{
    /**
     ...
     * @var string
     */
    protected $_eventPrefix = 'mw_freegift_rule';
    ...
    public function __construct(
        ...
        \MW\FreeGift\Model\Rule\Condition\CombineFactory $combineFactory,
        \MW\FreeGift\Model\Rule\Action\CollectionFactory $actionCollectionFactory,
        ...
        \MW\FreeGift\Model\Indexer\Rule\RuleProductProcessor $ruleProductProcessor,
    ...
    {
        parent::_construct();
        $this->_init('MW\FreeGift\Model\ResourceModel\Rule');
    ...
    public function _getRulesFromProductGift(
        $rule_id,
        $rule_gift_ids,
        $website_id = null,
        ...
        return $this->_getResource()->getRulesFromProductGift($rule_id, $rule_gift_ids, $website_id, $customer_group_id, $rule_product_id);
    }
    ...
    {
        if (!empty($this->_relatedCacheTypes)) {
