 ...
 */
namespace MW\FreeGift\Controller\Adminhtml\Promo\Widget;

class Chooser extends \MW\FreeGift\Controller\Adminhtml\Promo\Widget
{
    /**
        ...
        switch ($request->getParam('attribute')) {
            case 'sku':
                $block = $this->_view->getLayout()->createBlock(
                    'MW\FreeGift\Block\Adminhtml\Promo\Widget\Chooser\Sku',
