...
class ProcessApplyCoupon implements ObserverInterface
{
    /**
        ...
        if (!empty($ruleData)) {
            ...
            foreach ($giftData as $gift) {
                ...
                if ($gift['number_of_free_gift'] > $current_qty_gift) {
                    $this->addProduct($gift, $freegift_coupon_code, $parentKey);
                } else {
    ...
    public function addProduct($rule, $freegift_coupon_code, $parentKey)
    {
