...
//        $this->addChild('sales', 'Magento\Backend\Block\Dashboard\Sales');
        ...
        $this->addChild('mw_report', 'MW\FreeGift\Block\Adminhtml\Promo\Dashboard\Grid');
...
//            $block = $this->getLayout()->createBlock('Magento\Backend\Block\Dashboard\Diagrams');
            $block = $this->getLayout()->createBlock('MW\FreeGift\Block\Adminhtml\Promo\Dashboard\Diagrams');
        }else {
